...
public class  GraphUtils {
    ...
    public static String toDotColor(Graph graph, List<Integer> l, int start, int end) {
        StringBuilder sb = new StringBuilder();
        String nl = System.getProperty("line.separator");
        boolean isDigraph = graph instanceof Digraph;
        sb.append(isDigraph ? "digraph" : "strict graph").append(" {").append(nl);
        ...
        for (Integer i:l) {
            sb.append("{"+Integer.toString(i)+ " [color=red]}").append(nl);
        }
        sb.append("{"+Integer.toString(start)+ " [color=blue]}").append(nl);
        sb.append("{"+Integer.toString(end)+ " [color=blue]}").append(nl);
        sb.append("}").append(nl);
